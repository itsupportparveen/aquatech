<header class="u-clearfix u-header u-header" id="sec-f49a">
  <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
    <?php $logo = theme_get_logo(array(
            'default_src' => "/images/Logo.png",
            'default_url' => "#"
        )); $url = stripos($logo['url'], 'http') === 0 ? esc_url($logo['url']) : $logo['url']; ?><a <?php if (is_customize_preview()) echo 'data-default-src="' . esc_url($logo['default_src']) . '" '; ?>href="<?php echo $url; ?>" class="u-image u-logo u-image-1 custom-logo-link" data-image-width="960" data-image-height="987">
    ...
    <h3 class="u-headline u-text u-text-default u-text-palette-1-base u-text-1">
      <a href="<?php echo esc_url(home_url('/')); ?>"><?php $blogName = get_option('blogname'); if (strlen($blogName) > 0) { echo $blogName; } else {echo "Aquaeva Chemtech Pvt Ltd";}; ?></a>
    </h3>
    <?php
            ob_start();
